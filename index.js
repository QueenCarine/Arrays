...
let arr = ["boy", "man", "girl",  "school", "girl", "woman"];
let repeatingArray=[];
let nonRepeatingArray=arr.filter(function(item,index){
    if (arr.indexOf(item) !== index && !repeatingArray.includes(item)) {
        repeatingArray.push(item); 
    }
    return arr.indexOf(item) === index; 
});
console.log("Array without duplicates:",nonRepeatingArray);
console.log("Array with duplicates:",repeatingArray);
